    ...
    <div class="user-main-content-standardform-form">
        ...
        <div class="user-main-content-Longform-form-input-container">
            <div class="usermain-content-standardform-form-input-container">
                <div class="user-main-content-standardform-form-row">
                    <div class="user-main-content-standardform-form-column">
                        ...
                        <div type="text" class="user-main-content-standardform-form-input">{{$catHealthRecord->cat->name}}</div>
                    </div>
                    <div class="user-main-content-standardform-form-column">
                        <label class="user-main-content-standardform-form-label">Birthdate</label>
                        <div type="text" class="user-main-content-standardform-form-input">{{$catHealthRecord->cat->birthdate}}
                        </div>
                    </div>
                </div>
                <div class="user-main-content-standardform-form-row">
                    <div class="user-main-content-standardform-form-column">
                        ...
                        <div type="text" class="user-main-content-standardform-form-input">{{$catHealthRecord->cat->breed}}
                        </div>
                    </div>
                    <div class="user-main-content-standardform-form-column">
                        <label class="user-main-content-standardform-form-label">Gender</label>
                        <input type="text" class="user-main-content-standardform-form-input" placeholder=@if($catHealthRecord->cat->gender==false)
                            "Female"
                            @else
                            "Male"
                        @endif readonly>
            ...
            <div class="user-main-content-Longform-form-textarea-container">
                ...
                <textarea readonly id="autoResizeTextarea" rows="5" style="min-height: calc(1.5em * 5 + 8px);">{{$catHealthRecord->summary}}</textarea>
            </div>
        </div>
        <div class="user-main-content-standardform-form-button-container-row">
            <div class="user-main-content-standardform-form-button-container-column">
                <a href="{{route('medicalStaff.healthRecord.summaryList',['catID'=>$catID])}}" class="user-main-content-standardform-button">
                Back
                </a>
            </div>
        </div>
