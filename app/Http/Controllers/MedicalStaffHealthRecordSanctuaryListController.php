...
class MedicalStaffHealthRecordSanctuaryListController extends Controller
{
    public function index(Request $request){
        ...
        return view('MedicalStaffCatHealthRecordSanctuaryList', compact('sanctuaries','verifiedManagers','page'));
        } else {
        return view('MedicalStaffCatHealthRecordSanctuaryList', compact('verifiedManagers','page'));
        }
    }
}
