...
class MedicalStaffAppointmentSanctuaryListController extends Controller
{
    public function index(request $request){
        ...
        return view('MedicalStaffAppointmentSanctuaryList', compact('sanctuaries','verifiedManagers','page'));
        } else {
        return view('MedicalStaffAppointmentSanctuaryList', compact('verifiedManagers','page'));
        }
    }
}
